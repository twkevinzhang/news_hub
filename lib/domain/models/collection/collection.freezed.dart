...
mixin _$Collection {
  ...
  List<CollectionBoard> get boards => throw _privateConstructorUsedError;
...
abstract class $CollectionCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, List<CollectionBoard> boards});
}
...
class _$CollectionCopyWithImpl<$Res, $Val extends Collection>
  ...
  @override
  $Res call({Object? id = null, Object? name = null, Object? boards = null}) {
    return _then(
      _value.copyWith(
            id: null == id
                ? _value.id
...
class _$CollectionImpl implements _Collection {
  const _$CollectionImpl({
    required this.id,
    required this.name,
    required final List<CollectionBoard> boards,
  }) : _boards = boards;
  ...
  @override
  final String name;
  final List<CollectionBoard> _boards;
  @override
  List<CollectionBoard> get boards {
