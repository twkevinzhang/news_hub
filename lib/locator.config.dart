...
import 'package:news_hub/presentation/components/content-rendering/boards-picker/bloc/boards_picker_cubit.dart'
    as _i270;
import 'package:news_hub/presentation/pages/content-discovery/browse-threads/bloc/thread_list_cubit.dart'
    as _i698;
import 'package:news_hub/presentation/pages/content-discovery/read-thread/bloc/thread_detail_cubit.dart'
    as _i580;
import 'package:news_hub/presentation/pages/content-discovery/search-threads/bloc/search_cubit.dart'
    as _i702;
...
import 'package:news_hub/presentation/pages/extension-marketplace/manage-extensions/bloc/extension_cubit.dart'
    as _i917;
import 'package:news_hub/presentation/pages/extension-marketplace/manage-extensions/bloc/extension_repo_cubit.dart'
    as _i278;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.factory<_i853.CreateCollectionCubit>(
        () => _i853.CreateCollectionCubit(gh<_i920.CollectionRepository>()));
    ...
    gh.lazySingleton<_i446.InsertSuggestion>(() => _i446.InsertSuggestion(
        suggestionRepo: gh<_i677.SuggestionRepository>()));
    gh.factory<_i802.CollectionListBloc>(
        () => _i802.CollectionListBloc(gh<_i920.CollectionRepository>()));
    ...
    gh.factory<_i278.ExtensionRepoCubit>(() => _i278.ExtensionRepoCubit(
    ...
    gh.factory<_i670.SidecarLogsCubit>(() => _i670.SidecarLogsCubit(
          gh<_i466.SidecarRepository>(),
          gh<_i133.SidecarConnectionManager>(),
        ));
    gh.factory<_i832.SidecarCubit>(
        () => _i832.SidecarCubit(gh<_i466.SidecarRepository>()));
    ...
    gh.factory<_i270.BoardsPickerCubit>(
        () => _i270.BoardsPickerCubit(gh<_i351.ListInstalledExtensions>()));
    gh.factory<_i580.ThreadDetailCubit>(() => _i580.ThreadDetailCubit(
          getThread: gh<_i616.GetThread>(),
          listRegardingPosts: gh<_i492.ListRegardingPosts>(),
        ));
    gh.factory<_i917.ExtensionCubit>(() => _i917.ExtensionCubit(
    ...
    gh.factory<_i702.SearchCubit>(() => _i702.SearchCubit(
    ...
    gh.factory<_i698.ThreadListCubit>(() => _i698.ThreadListCubit(
          listThreadList: gh<_i757.ListThreads>(),
