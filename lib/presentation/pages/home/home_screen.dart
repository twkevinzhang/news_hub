...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _onRouteChanged() {
    ...
    // Get the deepest active route from the hierarchy
    final routes = context.router.currentHierarchy();
    final target = routes.isNotEmpty ? (routes.last as RouteData) : context.router.current;
          ...
          return Scaffold(
            ...
            drawer: AppNavigationDrawer(
              onCollectionSelected: (collection) {
                _safeNavigate(() => context.router.replace(CollectionThreadListRoute(collectionId: collection.id)));
              },
              onCreateCollectionPressed: () {
                _safeNavigate(() => context.router.push(CollectionCreateRoute()));
              },
              onBoardSelected: (board) {
                _safeNavigate(() => context.router.replace(CollectionBoardThreadListRoute(
