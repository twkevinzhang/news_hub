...
import 'package:news_hub/presentation/router/guards/home_guard.dart';
...
class AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
    AutoRoute(
      ...
      page: HomeRoute.page,
      children: [
        AutoRoute(path: '', page: HomeEmptyRoute.page, guards: [_homeGuard]),
        AutoRoute(
          path: 'collection/:collectionId/threads/list',
          page: CollectionThreadListRoute.page,
        ),
        AutoRoute(
          path: 'collection/:collectionId/boards/:boardId/threads/list',
          page: CollectionBoardThreadListRoute.page,
        ),
      ],
    ),
    AutoRoute(
