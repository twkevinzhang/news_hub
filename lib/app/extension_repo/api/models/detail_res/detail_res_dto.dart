...
class DetailResDto with _$DetailResDto {
  ...
  factory DetailResDto.fromJson(Map<String, dynamic> json) => _$DetailResDtoFromJson(json);
}
...
extension DetailResDtoEx on DetailResDto {
  T mapContent<T>(T Function(Map<String, dynamic>) toElement) {
    return toElement(jsonDecode(utf8.decode(base64Decode(content.remove('\n')))));
  }

  Iterable<T> mapIterableContent<T>(T Function(Map<String, dynamic>) toElement) {
    return (jsonDecode(utf8.decode(base64Decode(content.remove('\n')))) as Iterable).map((e) => toElement(e));
  }
}
