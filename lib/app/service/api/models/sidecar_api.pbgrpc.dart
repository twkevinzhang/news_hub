...
class SidecarApiClient extends $grpc.Client {
  ...
  /// Health check
  $grpc.ResponseFuture<$0.HealthCheckRes> healthCheck(
    $0.HealthCheckReq request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$healthCheck, request, options: options);
  }

  $grpc.ResponseStream<$0.HealthCheckRes> watchHealth(
    $0.HealthCheckReq request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
        _$watchHealth, $async.Stream.fromIterable([request]),
        options: options);
  }

  /// Logs
  $grpc.ResponseStream<$0.LogEntry> watchLogs(
    $0.WatchLogsReq request, {
    $grpc.CallOptions? options,
  }) {
    return $createStreamingCall(
  ...
  $grpc.ResponseFuture<$0.GetLogsRes> getLogs(
    $0.GetLogsReq request, {
    $grpc.CallOptions? options,
  }) {
    return $createUnaryCall(_$getLogs, request, options: options);
  }

  $grpc.ResponseFuture<$0.Empty> setLogLevel(
    $0.SetLogLevelReq request, {
    $grpc.CallOptions? options,
  }) {
  ...
  static final _$healthCheck =
      $grpc.ClientMethod<$0.HealthCheckReq, $0.HealthCheckRes>(
          ...
          $0.HealthCheckRes.fromBuffer);
  static final _$watchHealth =
      $grpc.ClientMethod<$0.HealthCheckReq, $0.HealthCheckRes>(
...
abstract class SidecarApiServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.HealthCheckRes> healthCheck(
      $grpc.ServiceCall call, $0.HealthCheckReq request);

  $async.Stream<$0.HealthCheckRes> watchHealth_Pre($grpc.ServiceCall $call,
      $async.Future<$0.HealthCheckReq> $request) async* {
    yield* watchHealth($call, await $request);
  }

  $async.Stream<$0.HealthCheckRes> watchHealth(
      $grpc.ServiceCall call, $0.HealthCheckReq request);

  $async.Stream<$0.LogEntry> watchLogs_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.WatchLogsReq> $request) async* {
    yield* watchLogs($call, await $request);
  }

  $async.Stream<$0.LogEntry> watchLogs(
      $grpc.ServiceCall call, $0.WatchLogsReq request);

  $async.Future<$0.GetLogsRes> getLogs_Pre(
      $grpc.ServiceCall $call, $async.Future<$0.GetLogsReq> $request) async {
    return getLogs($call, await $request);
  }

  $async.Future<$0.GetLogsRes> getLogs(
      $grpc.ServiceCall call, $0.GetLogsReq request);

  $async.Future<$0.Empty> setLogLevel_Pre($grpc.ServiceCall $call,
      $async.Future<$0.SetLogLevelReq> $request) async {
    return setLogLevel($call, await $request);
  }

  $async.Future<$0.Empty> setLogLevel(
      $grpc.ServiceCall call, $0.SetLogLevelReq request);
}
